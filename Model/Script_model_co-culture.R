...
pa <- readRDS("E:/Đề tài/GEM đi thi/pa.RDS") #directory file in your computer
sa <- readRDS("E:/Đề tài/GEM đi thi/sa.RDS") #directory file in your computer
...
arena_subs <- fread("E:/Đề tài/GEM đi thi/gapseq-master/dat/media/TSBmed.csv")
